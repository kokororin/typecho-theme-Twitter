jQuery(document).ready(function($) {
    $('.ProfileTweet-actionButton.action-more').click(function(event) {
        $(this).next('.dropdown-menu').toggle();
    });

    $('.embed-link.share-weibo').click(function(event) {
    ...
    $('.embed-link.add-fav').click(function(event) {
    ...
    $('#global-new-tweet-button').click(function(event) {
        location.href = $(this).data('href');
    });

    $('.TweetTextSize.tweet-text').click(function(event) {
        location.href = $(this).data('href');
    });
    ...
    $('.post-reply').click(function(event) {
        return TypechoComment.reply($(this).data('id'), $(this).data('coid'));
    });

    $('#mail').keyup(function() {
        var avatar = 'https://cdn.v2ex.com/gravatar/' + hex_md5(jQuery(this).val()) + '?s=60&amp;r=G&amp;d=';
        $('#comment-form').find('img').attr('src', avatar);

    });

    $('#comment-form>img').click(function() {
        $(".tweet-content>.author-info").slideToggle("slow");
    });

    $('#mo-reply').click(function() {
        $('#comment-form').submit();
    });
